...
class _EditOrUploadProductScreenState extends State<EditOrUploadProductScreen> {
  ...
  void initState() {
    ...
    _authorController =
        TextEditingController(text: widget.productModel?.productAutor);
    _descriptionController =
    ...
    if (isValid) {
      ...
      try {
        ...
        await FirebaseFirestore.instance
          ...
          'productAuthor': _authorController.text,
    ...
    if (isValid) {
      ...
      try {
        ...
        await FirebaseFirestore.instance
          ...
          'productTitle': _titleController.text,
          'productPrice': _authorController.text,
              ...
              child: Column(
                children: [
                  ...
                  DropdownButton<String>(
                    hint: Text(_categoryValue ?? "Wybierz Kategorie"),
                        ...
                        children: [
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                              hintText: 'Tytuł ksiązki',
                            ),
                            validator: (value) {
                              return MyValidators.uploadProdTexts(
                                value: value,
                                toBeReturnedString:
                                    "Dodaj poprawny tytuł ksiązki",
                              );
                            },
                          ),
                          const SizedBox(
                              ...
                              Flexible(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (value) {
                                    return MyValidators.uploadProdTexts(
                                      value: value,
                                      toBeReturnedString: "Brak autora",
                                    );
                                  },
                                ),
                              ),
                              ...
                              Flexible(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (value) {
                                    return MyValidators.uploadProdTexts(
                                      value: value,
                                      toBeReturnedString: "Podaj ilość",
                                    );
                                  },
                                ),
                              ),
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              return MyValidators.uploadProdTexts(
                                value: value,
                                toBeReturnedString: "Brakuje opisu",
                              );
                            },
                            onTap: () {},
                          ),
